...
export default function () {
  ...
  this.get('/remote/get_avail_resource_agents', () => ({
    'ocf:.isolation:docker-wrapper': { type: 'docker-wrapper' },
    'ocf:heartbeat:AoEtarget': { type: 'AoEtarget' },
    'ocf:heartbeat:AudibleAlarm': { type: 'AudibleAlarm' },
    'ocf:heartbeat:CTDB': { type: 'CTDB' },
    'ocf:heartbeat:ClusterMon': { type: 'ClusterMon' },
    'ocf:heartbeat:Delay': { type: 'Delay' },
    'ocf:heartbeat:Dummy': { type: 'Dummy' },
    'ocf:heartbeat:EvmsSCC': { type: 'EvmsSCC' },
    'ocf:heartbeat:Evmsd': { type: 'Evmsd' },
    'ocf:heartbeat:Filesystem': { type: 'Filesystem' },
    'ocf:heartbeat:ICP': { type: 'ICP' },
    'ocf:heartbeat:IPaddr': { type: 'IPaddr' },
    'ocf:heartbeat:IPaddr2': { type: 'IPaddr2' },
    'ocf:heartbeat:IPsrcaddr': { type: 'IPsrcaddr' },
    'ocf:heartbeat:LVM': { type: 'LVM' },
    'ocf:heartbeat:LinuxSCSI': { type: 'LinuxSCSI' },
    'ocf:heartbeat:MailTo': { type: 'MailTo' },
    'ocf:heartbeat:ManageRAID': { type: 'ManageRAID' },
    'ocf:heartbeat:ManageVE': { type: 'ManageVE' },
    'ocf:heartbeat:Pure-FTPd': { type: 'Pure-FTPd' },
    'ocf:heartbeat:Raid1': { type: 'Raid1' },
    'ocf:heartbeat:Route': { type: 'Route' },
    'ocf:heartbeat:SAPDatabase': { type: 'SAPDatabase' },
    'ocf:heartbeat:SAPInstance': { type: 'SAPInstance' },
    'ocf:heartbeat:SendArp': { type: 'SendArp' },
    'ocf:heartbeat:ServeRAID': { type: 'ServeRAID' },
    'ocf:heartbeat:SphinxSearchDaemon': { type: 'SphinxSearchDaemon' },
    'ocf:heartbeat:Squid': { type: 'Squid' },
    'ocf:heartbeat:Stateful': { type: 'Stateful' },
    'ocf:heartbeat:SysInfo': { type: 'SysInfo' },
    'ocf:heartbeat:VIPArip': { type: 'VIPArip' },
    'ocf:heartbeat:VirtualDomain': { type: 'VirtualDomain' },
    'ocf:heartbeat:WAS': { type: 'WAS' },
    'ocf:heartbeat:WAS6': { type: 'WAS6' },
    'ocf:heartbeat:WinPopup': { type: 'WinPopup' },
    'ocf:heartbeat:Xen': { type: 'Xen' },
    'ocf:heartbeat:Xinetd': { type: 'Xinetd' },
    'ocf:heartbeat:anything': { type: 'anything' },
    'ocf:heartbeat:apache': { type: 'apache' },
    'ocf:heartbeat:asterisk': { type: 'asterisk' },
    'ocf:heartbeat:clvm': { type: 'clvm' },
    'ocf:heartbeat:conntrackd': { type: 'conntrackd' },
    'ocf:heartbeat:db2': { type: 'db2' },
    'ocf:heartbeat:dhcpd': { type: 'dhcpd' },
    'ocf:heartbeat:dnsupdate': { type: 'dnsupdate' },
    'ocf:heartbeat:docker': { type: 'docker' },
    'ocf:heartbeat:eDir88': { type: 'eDir88' },
    'ocf:heartbeat:ethmonitor': { type: 'ethmonitor' },
    'ocf:heartbeat:exportfs': { type: 'exportfs' },
    'ocf:heartbeat:fio': { type: 'fio' },
    'ocf:heartbeat:galera': { type: 'galera' },
    'ocf:heartbeat:iSCSILogicalUnit': { type: 'iSCSILogicalUnit' },
    'ocf:heartbeat:iSCSITarget': { type: 'iSCSITarget' },
    'ocf:heartbeat:ids': { type: 'ids' },
    'ocf:heartbeat:iface-bridge': { type: 'iface-bridge' },
    'ocf:heartbeat:iface-vlan': { type: 'iface-vlan' },
    'ocf:heartbeat:iscsi': { type: 'iscsi' },
    'ocf:heartbeat:jboss': { type: 'jboss' },
    'ocf:heartbeat:kamailio': { type: 'kamailio' },
    'ocf:heartbeat:ldirectord': { type: 'ldirectord' },
    'ocf:heartbeat:lxc': { type: 'lxc' },
    'ocf:heartbeat:mysql': { type: 'mysql' },
    'ocf:heartbeat:mysql-proxy': { type: 'mysql-proxy' },
    'ocf:heartbeat:named': { type: 'named' },
    'ocf:heartbeat:nfsnotify': { type: 'nfsnotify' },
    'ocf:heartbeat:nfsserver': { type: 'nfsserver' },
    'ocf:heartbeat:nginx': { type: 'nginx' },
    'ocf:heartbeat:oracle': { type: 'oracle' },
    'ocf:heartbeat:oralsnr': { type: 'oralsnr' },
    'ocf:heartbeat:pgsql': { type: 'pgsql' },
    'ocf:heartbeat:pingd': { type: 'pingd' },
    'ocf:heartbeat:portblock': { type: 'portblock' },
    'ocf:heartbeat:postfix': { type: 'postfix' },
    'ocf:heartbeat:pound': { type: 'pound' },
    'ocf:heartbeat:proftpd': { type: 'proftpd' },
    'ocf:heartbeat:rabbitmq-cluster': { type: 'rabbitmq-cluster' },
    'ocf:heartbeat:redis': { type: 'redis' },
    'ocf:heartbeat:rsyncd': { type: 'rsyncd' },
    'ocf:heartbeat:rsyslog': { type: 'rsyslog' },
    'ocf:heartbeat:scsi2reservation': { type: 'scsi2reservation' },
    'ocf:heartbeat:sfex': { type: 'sfex' },
    'ocf:heartbeat:sg_persist': { type: 'sg_persist' },
    'ocf:heartbeat:slapd': { type: 'slapd' },
    'ocf:heartbeat:symlink': { type: 'symlink' },
    'ocf:heartbeat:syslog-ng': { type: 'syslog-ng' },
    'ocf:heartbeat:tomcat': { type: 'tomcat' },
    'ocf:heartbeat:varnish': { type: 'varnish' },
    'ocf:heartbeat:vmware': { type: 'vmware' },
    'ocf:heartbeat:zabbixserver': { type: 'zabbixserver' },
    'ocf:pacemaker:ClusterMon': { type: 'ClusterMon' },
    'ocf:pacemaker:Dummy': { type: 'Dummy' },
    'ocf:pacemaker:HealthCPU': { type: 'HealthCPU' },
    'ocf:pacemaker:HealthSMART': { type: 'HealthSMART' },
    'ocf:pacemaker:Stateful': { type: 'Stateful' },
    'ocf:pacemaker:SysInfo': { type: 'SysInfo' },
    'ocf:pacemaker:SystemHealth': { type: 'SystemHealth' },
    'ocf:pacemaker:controld': { type: 'controld' },
    'ocf:pacemaker:ping': { type: 'ping' },
    'ocf:pacemaker:pingd': { type: 'pingd' },
    'ocf:pacemaker:remote': { type: 'remote' },
    'lsb:netconsole': { type: 'netconsole' },
    'lsb:network': { type: 'network' },
    'systemd:abrt-ccpp': { type: 'abrt-ccpp' },
    'systemd:abrt-journal-core': { type: 'abrt-journal-core' },
    'systemd:abrt-oops': { type: 'abrt-oops' },
    'systemd:abrt-pstoreoops': { type: 'abrt-pstoreoops' },
    'systemd:abrt-vmcore': { type: 'abrt-vmcore' },
    'systemd:abrt-xorg': { type: 'abrt-xorg' },
    'systemd:abrtd': { type: 'abrtd' },
    'systemd:arp-ethers': { type: 'arp-ethers' },
    'systemd:atd': { type: 'atd' },
    'systemd:auditd': { type: 'auditd' },
    'systemd:auth-rpcgss-module': { type: 'auth-rpcgss-module' },
    'systemd:autofs': { type: 'autofs' },
    'systemd:autovt@': { type: 'autovt@' },
    'systemd:blk-availability': { type: 'blk-availability' },
    'systemd:certmonger': { type: 'certmonger' },
    'systemd:chrony-dnssrv@': { type: 'chrony-dnssrv@' },
    'systemd:chrony-wait': { type: 'chrony-wait' },
    'systemd:chronyd': { type: 'chronyd' },
    'systemd:cockpit': { type: 'cockpit' },
    'systemd:console-getty': { type: 'console-getty' },
    'systemd:console-shell': { type: 'console-shell' },
    'systemd:container-getty@': { type: 'container-getty@' },
    'systemd:corosync-notifyd': { type: 'corosync-notifyd' },
    'systemd:corosync': { type: 'corosync' },
    'systemd:crm_mon': { type: 'crm_mon' },
    'systemd:crond': { type: 'crond' },
    'systemd:dbus-org.fedoraproject.rolekit1': { type: 'dbus-org.fedoraproject.rolekit1' },
    'systemd:dbus-org.freedesktop.hostname1': { type: 'dbus-org.freedesktop.hostname1' },
    'systemd:dbus-org.freedesktop.import1': { type: 'dbus-org.freedesktop.import1' },
    'systemd:dbus-org.freedesktop.locale1': { type: 'dbus-org.freedesktop.locale1' },
    'systemd:dbus-org.freedesktop.login1': { type: 'dbus-org.freedesktop.login1' },
    'systemd:dbus-org.freedesktop.machine1': { type: 'dbus-org.freedesktop.machine1' },
    'systemd:dbus-org.freedesktop.network1': { type: 'dbus-org.freedesktop.network1' },
    'systemd:dbus-org.freedesktop.NetworkManager': {
      type: 'dbus-org.freedesktop.NetworkManager',
    },
    'systemd:dbus-org.freedesktop.nm-dispatcher': { type: 'dbus-org.freedesktop.nm-dispatcher' },
    'systemd:dbus-org.freedesktop.resolve1': { type: 'dbus-org.freedesktop.resolve1' },
    'systemd:dbus-org.freedesktop.timedate1': { type: 'dbus-org.freedesktop.timedate1' },
    'systemd:dbus': { type: 'dbus' },
    'systemd:debug-shell': { type: 'debug-shell' },
    'systemd:dlm': { type: 'dlm' },
    'systemd:dm-event': { type: 'dm-event' },
    'systemd:dnf-makecache': { type: 'dnf-makecache' },
    'systemd:dnsmasq': { type: 'dnsmasq' },
    'systemd:docker-storage-setup': { type: 'docker-storage-setup' },
    'systemd:docker': { type: 'docker' },
    'systemd:dracut-cmdline': { type: 'dracut-cmdline' },
    'systemd:dracut-initqueue': { type: 'dracut-initqueue' },
    'systemd:dracut-mount': { type: 'dracut-mount' },
    'systemd:dracut-pre-mount': { type: 'dracut-pre-mount' },
    'systemd:dracut-pre-pivot': { type: 'dracut-pre-pivot' },
    'systemd:dracut-pre-trigger': { type: 'dracut-pre-trigger' },
    'systemd:dracut-pre-udev': { type: 'dracut-pre-udev' },
    'systemd:dracut-shutdown': { type: 'dracut-shutdown' },
    'systemd:ebtables': { type: 'ebtables' },
    'systemd:emergency': { type: 'emergency' },
    'systemd:fancontrol': { type: 'fancontrol' },
    'systemd:fedora-autorelabel-mark': { type: 'fedora-autorelabel-mark' },
    'systemd:fedora-autorelabel': { type: 'fedora-autorelabel' },
    'systemd:fedora-domainname': { type: 'fedora-domainname' },
    'systemd:fedora-import-state': { type: 'fedora-import-state' },
    'systemd:fedora-loadmodules': { type: 'fedora-loadmodules' },
    'systemd:fedora-readonly': { type: 'fedora-readonly' },
    'systemd:firewalld': { type: 'firewalld' },
    'systemd:fprintd': { type: 'fprintd' },
    'systemd:fstrim': { type: 'fstrim' },
    'systemd:getty@': { type: 'getty@' },
    'systemd:gssproxy': { type: 'gssproxy' },
    'systemd:halt-local': { type: 'halt-local' },
    'systemd:initrd-cleanup': { type: 'initrd-cleanup' },
    'systemd:initrd-parse-etc': { type: 'initrd-parse-etc' },
    'systemd:initrd-switch-root': { type: 'initrd-switch-root' },
    'systemd:initrd-udevadm-cleanup-db': { type: 'initrd-udevadm-cleanup-db' },
    'systemd:ipmievd': { type: 'ipmievd' },
    'systemd:irda': { type: 'irda' },
    'systemd:irqbalance': { type: 'irqbalance' },
    'systemd:iscsi-shutdown': { type: 'iscsi-shutdown' },
    'systemd:iscsi': { type: 'iscsi' },
    'systemd:iscsid': { type: 'iscsid' },
    'systemd:iscsiuio': { type: 'iscsiuio' },
    'systemd:kdump': { type: 'kdump' },
    'systemd:kmod-static-nodes': { type: 'kmod-static-nodes' },
    'systemd:ldconfig': { type: 'ldconfig' },
    'systemd:lm_sensors': { type: 'lm_sensors' },
    'systemd:lvm2-lvmetad': { type: 'lvm2-lvmetad' },
    'systemd:lvm2-lvmpolld': { type: 'lvm2-lvmpolld' },
    'systemd:lvm2-monitor': { type: 'lvm2-monitor' },
    'systemd:lvm2-pvscan@': { type: 'lvm2-pvscan@' },
    'systemd:mcelog': { type: 'mcelog' },
    'systemd:mdadm-grow-continue@': { type: 'mdadm-grow-continue@' },
    'systemd:mdadm-last-resort@': { type: 'mdadm-last-resort@' },
    'systemd:mdmon@': { type: 'mdmon@' },
    'systemd:mdmonitor': { type: 'mdmonitor' },
    'systemd:messagebus': { type: 'messagebus' },
    'systemd:mlocate-updatedb': { type: 'mlocate-updatedb' },
    'systemd:multipathd': { type: 'multipathd' },
    'systemd:NetworkManager-dispatcher': { type: 'NetworkManager-dispatcher' },
    'systemd:NetworkManager-wait-online': { type: 'NetworkManager-wait-online' },
    'systemd:NetworkManager': { type: 'NetworkManager' },
    'systemd:nfs-blkmap': { type: 'nfs-blkmap' },
    'systemd:nfs-config': { type: 'nfs-config' },
    'systemd:nfs-idmap': { type: 'nfs-idmap' },
    'systemd:nfs-idmapd': { type: 'nfs-idmapd' },
    'systemd:nfs-lock': { type: 'nfs-lock' },
    'systemd:nfs-mountd': { type: 'nfs-mountd' },
    'systemd:nfs-secure': { type: 'nfs-secure' },
    'systemd:nfs-server': { type: 'nfs-server' },
    'systemd:nfs-utils': { type: 'nfs-utils' },
    'systemd:nfs': { type: 'nfs' },
    'systemd:ntpd': { type: 'ntpd' },
    'systemd:ntpdate': { type: 'ntpdate' },
    'systemd:oddjobd': { type: 'oddjobd' },
    'systemd:openhpid': { type: 'openhpid' },
    'systemd:pacemaker': { type: 'pacemaker' },
    'systemd:packagekit-offline-update': { type: 'packagekit-offline-update' },
    'systemd:packagekit': { type: 'packagekit' },
    'systemd:pcscd': { type: 'pcscd' },
    'systemd:pcsd': { type: 'pcsd' },
    'systemd:plymouth-halt': { type: 'plymouth-halt' },
    'systemd:plymouth-kexec': { type: 'plymouth-kexec' },
    'systemd:plymouth-poweroff': { type: 'plymouth-poweroff' },
    'systemd:plymouth-quit-wait': { type: 'plymouth-quit-wait' },
    'systemd:plymouth-quit': { type: 'plymouth-quit' },
    'systemd:plymouth-read-write': { type: 'plymouth-read-write' },
    'systemd:plymouth-reboot': { type: 'plymouth-reboot' },
    'systemd:plymouth-start': { type: 'plymouth-start' },
    'systemd:plymouth-switch-root': { type: 'plymouth-switch-root' },
    'systemd:polkit': { type: 'polkit' },
    'systemd:psacct': { type: 'psacct' },
    'systemd:quotaon': { type: 'quotaon' },
    'systemd:rc-local': { type: 'rc-local' },
    'systemd:rdisc': { type: 'rdisc' },
    'systemd:realmd': { type: 'realmd' },
    'systemd:rescue': { type: 'rescue' },
    'systemd:rngd': { type: 'rngd' },
    'systemd:rolekit': { type: 'rolekit' },
    'systemd:rpc-gssd': { type: 'rpc-gssd' },
    'systemd:rpc-statd-notify': { type: 'rpc-statd-notify' },
    'systemd:rpc-statd': { type: 'rpc-statd' },
    'systemd:rpc-svcgssd': { type: 'rpc-svcgssd' },
    'systemd:rpcbind': { type: 'rpcbind' },
    'systemd:rsyslog': { type: 'rsyslog' },
    'systemd:serial-getty@': { type: 'serial-getty@' },
    'systemd:smartd': { type: 'smartd' },
    'systemd:sshd-keygen': { type: 'sshd-keygen' },
    'systemd:sshd': { type: 'sshd' },
    'systemd:sshd@': { type: 'sshd@' },
    'systemd:sssd': { type: 'sssd' },
    'systemd:storaged': { type: 'storaged' },
    'systemd:stunnel': { type: 'stunnel' },
    'systemd:syslog': { type: 'syslog' },
    'systemd:systemd-ask-password-console': { type: 'systemd-ask-password-console' },
    'systemd:systemd-ask-password-plymouth': { type: 'systemd-ask-password-plymouth' },
    'systemd:systemd-ask-password-wall': { type: 'systemd-ask-password-wall' },
    'systemd:systemd-backlight@': { type: 'systemd-backlight@' },
    'systemd:systemd-binfmt': { type: 'systemd-binfmt' },
    'systemd:systemd-bootchart': { type: 'systemd-bootchart' },
    'systemd:systemd-bus-proxyd': { type: 'systemd-bus-proxyd' },
    'systemd:systemd-firstboot': { type: 'systemd-firstboot' },
    'systemd:systemd-fsck-root': { type: 'systemd-fsck-root' },
    'systemd:systemd-fsck@': { type: 'systemd-fsck@' },
    'systemd:systemd-halt': { type: 'systemd-halt' },
    'systemd:systemd-hibernate-resume@': { type: 'systemd-hibernate-resume@' },
    'systemd:systemd-hibernate': { type: 'systemd-hibernate' },
    'systemd:systemd-hostnamed': { type: 'systemd-hostnamed' },
    'systemd:systemd-hwdb-update': { type: 'systemd-hwdb-update' },
    'systemd:systemd-hybrid-sleep': { type: 'systemd-hybrid-sleep' },
    'systemd:systemd-importd': { type: 'systemd-importd' },
    'systemd:systemd-initctl': { type: 'systemd-initctl' },
    'systemd:systemd-journal-catalog-update': { type: 'systemd-journal-catalog-update' },
    'systemd:systemd-journal-flush': { type: 'systemd-journal-flush' },
    'systemd:systemd-journald': { type: 'systemd-journald' },
    'systemd:systemd-kexec': { type: 'systemd-kexec' },
    'systemd:systemd-localed': { type: 'systemd-localed' },
    'systemd:systemd-logind': { type: 'systemd-logind' },
    'systemd:systemd-machine-id-commit': { type: 'systemd-machine-id-commit' },
    'systemd:systemd-machined': { type: 'systemd-machined' },
    'systemd:systemd-modules-load': { type: 'systemd-modules-load' },
    'systemd:systemd-networkd-wait-online': { type: 'systemd-networkd-wait-online' },
    'systemd:systemd-networkd': { type: 'systemd-networkd' },
    'systemd:systemd-nspawn@': { type: 'systemd-nspawn@' },
    'systemd:systemd-poweroff': { type: 'systemd-poweroff' },
    'systemd:systemd-quotacheck': { type: 'systemd-quotacheck' },
    'systemd:systemd-random-seed': { type: 'systemd-random-seed' },
    'systemd:systemd-reboot': { type: 'systemd-reboot' },
    'systemd:systemd-remount-fs': { type: 'systemd-remount-fs' },
    'systemd:systemd-resolved': { type: 'systemd-resolved' },
    'systemd:systemd-rfkill@': { type: 'systemd-rfkill@' },
    'systemd:systemd-suspend': { type: 'systemd-suspend' },
    'systemd:systemd-sysctl': { type: 'systemd-sysctl' },
    'systemd:systemd-sysusers': { type: 'systemd-sysusers' },
    'systemd:systemd-timedated': { type: 'systemd-timedated' },
    'systemd:systemd-timesyncd': { type: 'systemd-timesyncd' },
    'systemd:systemd-tmpfiles-clean': { type: 'systemd-tmpfiles-clean' },
    'systemd:systemd-tmpfiles-setup-dev': { type: 'systemd-tmpfiles-setup-dev' },
    'systemd:systemd-tmpfiles-setup': { type: 'systemd-tmpfiles-setup' },
    'systemd:systemd-udev-settle': { type: 'systemd-udev-settle' },
    'systemd:systemd-udev-trigger': { type: 'systemd-udev-trigger' },
    'systemd:systemd-udevd': { type: 'systemd-udevd' },
    'systemd:systemd-update-done': { type: 'systemd-update-done' },
    'systemd:systemd-update-utmp-runlevel': { type: 'systemd-update-utmp-runlevel' },
    'systemd:systemd-update-utmp': { type: 'systemd-update-utmp' },
    'systemd:systemd-user-sessions': { type: 'systemd-user-sessions' },
    'systemd:systemd-vconsole-setup': { type: 'systemd-vconsole-setup' },
    'systemd:tcsd': { type: 'tcsd' },
    'systemd:timedatex': { type: 'timedatex' },
    'systemd:tog-pegasus': { type: 'tog-pegasus' },
    'systemd:unbound-anchor': { type: 'unbound-anchor' },
    'systemd:user@': { type: 'user@' },
    'systemd:winbind': { type: 'winbind' },
    'nagios:check_fping': { type: 'check_fping' },
    'nagios:check_http': { type: 'check_http' },
    'nagios:check_ldap': { type: 'check_ldap' },
    'nagios:check_mysql': { type: 'check_mysql' },
    'nagios:check_pgsql': { type: 'check_pgsql' },
    'nagios:check_tcp': { type: 'check_tcp' },
    'nagios:check_udp': { type: 'check_udp' },
  }));
